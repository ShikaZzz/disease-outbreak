...
poilo = pd.read_csv('polio.csv',usecols=['Cname','2014','Cases'],encoding = "ISO-8859-1")
poilo.columns = ['Country','2014','Cases']
...
ebola_fatality = '50%.'
sars_fatality ='11%'
pop_fatatlity = '2.5%, child, 22.5%,adult'
...
diseases = pd.DataFrame({
    'disease' : ['H1N1','SARS', 'EBOLA','poilo' ],
    'confirmed' : [h_cases, s_cases, e_cases,p_cases],
    'deaths' : [h_deaths, s_deaths, e_deaths, p_deaths],
    'no_of_countries' : [h_countries, s_countries, e_countries,p_countries],
    'fatality_rate':[h1n1_fatality,sars_fatality,ebola_fatality,pop_fatatlity]
})
...
159951.0*0.7*0.025+159951.0*0.3*0.225
...
fig = px.bar(diseases.sort_values('confirmed',ascending=False), 
             ...
             range_x=[0,7700000],
             color_discrete_sequence = [h1n1_color, ebola_color, sars_color,pop_color])
